...
https://www.chromium.org/chromium-os/developer-library/reference/linux-constants/syscalls/[window=_blank]
...
* *Nomenclature*: __x0__–__x7__ (function arguments), __x0__ (return value)
...
* *ARM64* emphasizes register-based calling conventions with `x0–x7` for arguments.
