...
function newWindow() {
        ...
        output += "<td colspan='4' width='100%' bgcolor='#cc6633'><img src='../i/c.gif' height='5' width='1' alt='spacer gif'></td>"
        output += "</tr>"
        output += "<tr valign='top' align='left'>"
        output += "<td colspan='4' width='100%' bgcolor='#000000'><img src='../i/c.gif' height='1' width='1' alt='spacer gif'></td>"
        output += "</tr>"
        output += "<tr valign='top'>"
        output += "<td align='left'><img src='../i/c.gif' height='1' width='5' alt='spacer gif'></td>"
        output += "<td align='left'><img src='../i/email.gif' height='45' width='215' alt='e-mail it!'></td>"
        output += "<td align='right'><img src='../i/dw-logo2.gif' height='27' width='123' alt='developerWorks'></td>"
        output += "<td align='right'><img src='../i/c.gif' height='1' width='5' alt='spacer gif'></td>"
        output += "</tr>"
        output += "<tr valign='top'>"
        output += "<td align='left'><img src='../i/c.gif' height='1' width='5' alt='spacer gif'></td>"
        ...
        output += "</tr>"
        output += "<tr valign=top align=left>"
        output += "<td width=80>&nbsp;</td><td><input type='image' border='0' name='Send' src='../i/btn-send.gif' border='0' height='19' width='47' alt='send'><A HREF='javascript:void parent.close()'><img src='../i/btn-close.gif' border=0 height='19' width='103' alt='Close window'</a></td>"
        output += "</tr>"
        output += "</table>"
        output += "</td>"
        output += "<td align='left'><img src='../i/c.gif' height='1' width='5' alt='spacer gif'></td>"
